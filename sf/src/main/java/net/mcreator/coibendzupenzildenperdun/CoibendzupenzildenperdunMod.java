package net.mcreator.coibendzupenzildenperdun;
...
@Mod("coibendzupenzildenperdun")
public class CoibendzupenzildenperdunMod {
	public static final Logger LOGGER = LogManager.getLogger(CoibendzupenzildenperdunMod.class);
	public static final String MODID = "coibendzupenzildenperdun";

	public CoibendzupenzildenperdunMod(IEventBus modEventBus) {
